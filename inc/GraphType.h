...
public:
    ...
    /**
     * @brief Build the network graph from the xml tree 
     * 
     * @param file_tree: The tree to build the network graph from.
     */
    void build_Graph(XML_Tree *file_tree);

    /**
     * @brief Return the ID of the vertex at the specified index.
     * 
...
/** @defgroup Getters of the private fields
  * @{
  */
